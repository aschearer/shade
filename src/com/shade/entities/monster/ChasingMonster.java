 ...
 */
public class ChasingMonster implements State {

	private Monster monster;
	private Animation idling;
	private int timer;

	public ChasingMonster(Monster mole) throws SlickException {
		this.monster = mole;
		initResources();
	}
	...
	public boolean isNamed(Object o) {
		return o == Monster.States.CHASING;
	}
	...
	private void chase() {
		...
		else monster.manager.enter(Monster.States.LOST);
	}
