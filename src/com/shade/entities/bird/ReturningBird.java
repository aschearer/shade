...
public class ReturningBird implements State {
    ...
    public void enter() {
        ...
        idling.restart();
        if(bird.level!=null){
        	Object[] spots = bird.level.getEntitiesByRole(Roles.OBSTACLE.ordinal());
    ...
    public void update(StateBasedGame game, int delta) {
        idling.update(delta);
        testTimer(delta);
        if(bird.level!=null&&nest==null)bird.manager.enter(Bird.States.RETURNING);
        if(nest!=null){
